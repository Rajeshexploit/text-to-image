...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-water-688b)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/still-water-688b
```

A live public deployment of this template is available at [https://still-water-688b.templates.workers.dev](https://still-water-688b.templates.workers.dev)
